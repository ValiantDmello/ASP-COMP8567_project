...
//Usage: ./mirror [port number]

//This code is an exact copy of server code, 
//except for the for loop in main function
...
int processclient(int newsockfd){
    ...
    //sleep(1);
    char *msg = "Connected to mirror  ";  //send message to client that it is connected to mirror
...
int main(int argc, char  *argv[]){
    ...
    while(1){   //loop to accept clients
        ...
        if(clientcounter>=1 && clientcounter<=4){       //first 4 client(1-4)
